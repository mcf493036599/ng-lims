...
@NgModule({
  ...
  declarations: [InstrumentComponent, DepartmentListComponent, InstrumentListComponent, InstrumentCardComponent, UserInfoCardComponent, InstrumentDetailComponent]
})
